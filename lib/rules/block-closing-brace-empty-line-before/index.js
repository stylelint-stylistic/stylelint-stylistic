		...
		function check (statement) {
			...
			report({
				...
				fix () {
					...
					// The break to write where the file ends no line at all, and the only place this rule needs it: an empty line is otherwise spelled with a break the file already uses
