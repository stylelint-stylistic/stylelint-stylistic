 ...
 * @returns {node is import('postcss-value-parser').StringNode} True where the node is a row of the grid.
 */
 ...
 * @type {import('stylelint').RuleBase<true, { gap?: number, alignQuotes?: boolean }>}
 */
	...
	return (root, result) => {
		let validOptions = validateOptions(
			...
			{ actual: primary },
			{
				...
				possible: {
					gap: [isNumber, (value) => Number(value) > 1],
