...
testRule({
	...
	reject: [
		...
		},
		{
			...
			code: `a { grid-template-areas: "a\na"\n"bb bb"; }`,
			fixed: `a { grid-template-areas: "a  a"\n"bb bb"; }`,
			line: 1,
			column: 26,
			endLine: 3,
			endColumn: 8,
		...
		},
		{
			...
			code: `a { grid-template-areas: "a\na" var(--x\n) "bb bb"; }`,
			fixed: `a { grid-template-areas: "a  a" var(--x\n) "bb bb"; }`,
			line: 1,
			column: 26,
			endLine: 3,
			endColumn: 10,
		...
		},
		{
			...
			code: `a { grid-template-areas: var(--x\n) "a\na" "bb bb"; }`,
			fixed: `a { grid-template-areas: var(--x\n) "a  a" "bb bb"; }`,
			line: 1,
			column: 26,
			endLine: 3,
			endColumn: 11,
		...
		},
		{
			...
			code: `a { grid-template-areas: x\\\na "a\na" "bb bb"; }`,
			fixed: `a { grid-template-areas: x\\\na "a  a" "bb bb"; }`,
			line: 1,
			column: 26,
			endLine: 3,
			endColumn: 11,
		...
		},
		{
			...
			code: `a { grid-template-areas: "a  b"\r"cc  c"; }`,
			fixed: `a { grid-template-areas: "a b"\r"cc c"; }`,
			line: 1,
			column: 26,
			endLine: 1,
			endColumn: 40,
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			code: `a { grid-template-areas: "\n" "bb bb"; }`,
			fixed: `a { grid-template-areas: "" "bb bb"; }`,
			line: 1,
			column: 26,
			endLine: 2,
			endColumn: 10,
...
// The rows of the `grid-template` and `grid` shorthands are read as the longhand's: every top-level string of the value is a row, and a row's size, its line names, the solidus and the columns behind it go back as the file spells them.
testRule({
	ruleName,
	config: [true],
...
// Under `alignColumns` a shorthand's row lines are laid out as a table, the line names in front, the row, its size and the names behind each in a column, the padding written between a line's tokens and never in front of its first.
testRule({
	ruleName,
