...
import { assertString } from "../../utils/validateTypes/index.js"
 ...
 * @type {import('stylelint').RuleBase<'always' | 'never' | 'always-single-line'>}
 */
	...
	return (root, result) => {
		...
		declarationColonSpaceChecker({
			...
			fix: (decl, index) => {
				...
				if (colonIndex === between.length - 1) moveDeclarationValueHeadIntoBetween(decl, /** @type {RegExpMatchArray} */ (getDeclarationValue(decl).match(LEADING_WHITESPACE))[0].length)
