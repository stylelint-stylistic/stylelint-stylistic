...
function rule (primary) {
	...
	return (root, result) => {
		...
		valueListCommaWhitespaceChecker({
			...
			// rule could write would reach it. A comma opening the value is refused along with
			// it, and rightly: the whitespace in front of that one is the declaration's
			// `raws.between`, which this rule does not write either. Reaching it is #166.
