...
function rule (primary) {
	...
	return (root, result) => {
		...
		valueListCommaWhitespaceChecker({
			...
			isFixable: (declNode, index, declString) => index >= declarationValueIndex(declNode) && (!readsInlineComments(declNode, result) || !endsWithInlineComment(declString.slice(0, index))),
			fix: (declNode, index) => {
