...
// The `<ratio>` of a media feature is read under the same options as the property's value, in the plain and the range form, `device-aspect-ratio` and the `min-` and `max-` spellings of both included.
testRule({
	ruleName,
	config: [`ratio`],
