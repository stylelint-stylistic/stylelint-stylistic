...
Require a single space or disallow whitespace before the solidus that separates the parts of a value.
...
There _must always_ be a single space before the solidus in single-line declarations.
...
There _must never_ be whitespace before the solidus in single-line declarations.
