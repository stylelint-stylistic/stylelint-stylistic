...
function rule (primary, _secondaryOptions, context) {
	...
	return (root, result) => {
		...
		root.walkDecls((decl) => {
			...
			// The extra characters tacked onto the end ensure that there is a character to check after the colon. Otherwise, with `background:pink` the character after the
