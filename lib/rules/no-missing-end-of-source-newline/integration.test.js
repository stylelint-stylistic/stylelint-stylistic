 ...
 * @param {object} rules - The two rules, in the order the configuration is to spell them.
 * @returns {Promise<{ code: string, warnings: number }>} What the run left behind and how much of it the pair still has to say about.
 */
 ...
 * @param {string} code - The snippet.
 * @param {object} partner - The other rule of the pair, as a configuration of one rule.
 * @param {string} expected - The file both orders are to leave.
 * @returns {Promise<void>} Nothing.
 */
async function expectBothOrders (code, partner, expected) {
