	...
	return (root, result) => {
		...
		report({
			...
			fix () {
				...
				root.raws.after = endsTheLine ? ended : after + (getLineEnding(root) ?? context.newline)
			},
		})
	}
}
