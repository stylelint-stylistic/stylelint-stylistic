...
let shortName = `value-slash-space-after`

const MESSAGES = defineMessages({
	expectedAfter: () => `Expected single space after "/"`,
	rejectedAfter: () => `Unexpected whitespace after "/"`,
	expectedAfterSingleLine: () => `Expected single space after "/" in a single-line declaration`,
	rejectedAfterSingleLine: () => `Unexpected whitespace after "/" in a single-line declaration`,
})
...
/**
 * Requires a single space or disallows whitespace after the solidus that separates the parts of a value.
