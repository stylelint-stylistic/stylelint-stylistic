...
testRule({
	...
	reject: [
		...
		{
			// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/248
			description: `an inline comment abutting the semicolon and closed by a bare carriage return, which ends its line as readily as a line feed`,
			code: `a { color: pink;// c\rtop: 0;\r}`,
			fixed: `a { color: pink;// c\rtop: 0;\r}`,
			line: 1,
			column: 17,
			message: messages.rejectedAfterMultiLine(),
		},
		{
			// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/248
			// This syntax measures the warning on a line the file does not spell it on, which is #139 a line further out than the columns above, so this case asserts no position at all
