		...
		function checkMultilineBit (source, newlineIndentLevel, node) {
			...
			styleSearch(
				...
				(match, matchCount) => {
					...
					// Starting at the index after the newline, we want to check that the whitespace characters (excluding newlines) before the first non-whitespace character equal the expected indentation
