 ...
 * @type {import('stylelint').RuleBase<number | 'tab', { baseIndentLevel?: number | 'auto', except?: ('block' | 'value' | 'param')[], ignore?: ('value' | 'param' | 'inside-parens')[], indentInsideParens?: 'twice' | 'once-at-root-twice-in-block', indentClosingBrace?: boolean }>}
 */
 ...
 * @param {number | 'auto' | undefined} baseIndentLevel - The base indent level option.
 * @param {number | 'tab'} space - The primary option: the number of spaces of one level, or `tab`.
