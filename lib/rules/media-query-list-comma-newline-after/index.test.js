...
testRule({
	...
	accept: [
		...
		},
		{
			...
			description: `a comment behind a form feed, which stands on a line of its own rather than on the comma's, so nothing is asked of the text behind it`,
			code: `@media screen and (color),\f/*comment*/projection and (color) {}`,
		},
		{
	...
	reject: [
		{
			...
			code: `@media screen and (color),  \rprojection and (color) {}`,
			fixed: `@media screen and (color),\rprojection and (color) {}`,
			line: 1,
			column: 26,
		...
		},
		{
			...
			fixed: `@media screen and (color),\fprojection and (color) {}`,
			line: 1,
			column: 26,
			message: messages.expectedAfter(),
		},
...
testRule({
	...
	accept: [
		...
		{
			// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/204
			description: `an end-of-line comment closed by a bare carriage return, which the fix used to push onto a line of its own`,
			code: `@media screen and (color), // scss\rprojection and (color) {}`,
		},
		{
			description: `an end-of-line comment closed by a form feed, which Sass reads a line in`,
			code: `@media screen and (color), // scss\fprojection and (color) {}`,
		},
	],
})
...
testRule({
	...
	accept: [
		...
		{
			// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/204
			description: `an end-of-line comment closed by a bare carriage return, which Less turns into a line feed before it reads the file`,
			code: `@media screen and (color), // less\rprojection and (color) {}`,
		},
	],
})
