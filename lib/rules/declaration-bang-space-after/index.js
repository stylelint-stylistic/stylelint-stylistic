	...
	return (root, result) => {
		...
		declarationBangSpaceChecker({
			...
			fix: (target) => {
				...
				// Where the whitespace run behind the bang ends, which is where the text picks up again: a bang the text ends on has no run behind it, and the write is an insertion
