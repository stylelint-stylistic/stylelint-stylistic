...
import { atRuleNameSpaceChecker } from "../../utils/atRuleNameSpaceChecker/index.js"
...
function rule (primary) {
	...
	return (root, result) => {
		...
		atRuleNameSpaceChecker({
			...
			fix: (atRule) => {
				if (typeof atRule.raws.afterName === `string`) atRule.raws.afterName = atRule.raws.afterName.replace(/^\s*/u, ` `)
			},
		})
	}
}
