...
function rule (primary, secondaryOptions) {
	return (root, result) => {
		...
		function checkNewline (match) {
			...
			// If the line's length is less than or equal to the specified max, ignore it ... So anything below is liable to be complained about. **Note that the length of any url arguments or import urls are excluded from the calculation.**
