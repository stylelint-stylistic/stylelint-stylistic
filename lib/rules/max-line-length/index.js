 ...
 * @type {import('stylelint').RuleBase<number, { ignore?: ('non-comments' | 'comments') | ('non-comments' | 'comments')[], ignorePattern?: string | RegExp | (string | RegExp)[], tabSize?: number }>}
 */
		...
		let validOptions = validateOptions(
			...
			},
			{
				...
				possible: {
					...
					tabSize: [(value) => isNumber(value) && Number.isInteger(value) && value > 0],
				},
				optional: true,
			},
		)
