 ...
 * @returns {import('../../utils/findInlineCommentSpans/index.ts').InlineCommentSpan[]} The spans, in the coordinates of the value the file spells.
 */
 ...
 * @param {{ declValue: string, valueNode: FunctionNode, openingIndex: number, checkBefore: string, checkAfter: string, firstIndex: number, measured: number[][], reading: import('../../utils/readsInlineComments/index.ts').InlineCommentReading }} read - What the walk has read of the function, and the value it was read from.
