...
function rule (primary, _secondaryOptions, context) {
	return (root, result) => {
		...
		root.walkDecls((decl) => {
			...
			let inlineComments = findInlineCommentSpans(declValue, endsOnFormFeed, reading.spells)
			...
			parsedValue.walk((valueNode) => {
				...
				if (areSpansStale) {
					inlineComments = findInlineCommentSpansAfterEdits(declValue, edits, endsOnFormFeed, reading.spells)
					areSpansStale = false
				}
