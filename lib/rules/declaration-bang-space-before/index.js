...
function rule (primary) {
	...
	return (root, result) => {
		...
		declarationBangSpaceChecker({
			...
			fix: (target) => {
				// The whitespace run in front of the bang is what either option writes over, and where the bang opens the text it stands in, that run is empty and the write is an insertion
