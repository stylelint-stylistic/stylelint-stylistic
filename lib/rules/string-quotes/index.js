...
/**
 * Finds the spans the inline comments of a string occupy in it. A double slash inside a quoted string or a block comment opens no comment, and a comment ends with its line rather than with the string.
