...
function rule (primary, secondaryOptions) {
	...
	return (root, result) => {
		...
		//
		// A stylesheet embedded in a page carries the syntax of its own block, and it is that one
		// the question belongs to: the syntax the file was opened with parses the page rather than
		// the style, and one page may hold blocks written in several languages.
