...
import { CRLF, EVERY_LINE_BREAK, EVERY_LINE_WITH_BREAK, LINE_BREAK } from "../../regexps.js"
 ...
 * @type {import('stylelint').RuleBase<'unix' | 'windows'>}
 */
function rule (primary) {
	return (root, result) => {
		...
		function reportNewlineError (line, column) {
			...
			let node = _rule(/** @type {import('postcss').RuleProps} */ ({
				source: {
