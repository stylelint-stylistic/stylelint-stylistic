...
testRule({
	...
	reject: [
		...
		// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/283
		{
			description: `a bare carriage return in front of the closing delimiter of a comment that ends the stylesheet`,
			code: `a { b: 1; } /* c\r*/`,
			fixed: `a { b: 1; } /* c\n*/`,
			line: 1,
			column: 19,
...
testRule({
	...
	reject: [
		...
		// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/270
		{
			description: `a bare carriage return closing that comment, the break the fix used to take away rather than respell`,
			code: `@media (min-width: 100px // c\r\t) { a { color: red; } }`,
			fixed: `@media (min-width: 100px // c\n\t) { a { color: red; } }`,
			line: 1,
			column: 54,
			message: messages.expected(`unix`),
		},
...
testRule({
	...
	reject: [
		...
		// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/270
		{
			description: `a bare carriage return closing an end-of-line comment a set of at-rule parameters holds`,
			code: `@media (min-width: 100px // c\r\t) { a { color: red; } }`,
			fixed: `@media (min-width: 100px // c\n\t) { a { color: red; } }`,
			line: 1,
			column: 54,
		...
		// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/283
		{
			description: `a bare carriage return closing an end-of-line comment that ends the stylesheet, which this syntax files where a block comment keeps the whitespace in front of its closing delimiter`,
			code: `a { b: 1; } // c\r`,
			fixed: `a { b: 1; } // c\n`,
			line: 1,
			column: 17,
