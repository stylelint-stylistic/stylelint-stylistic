...
testRule({
	...
	reject: [
		...
		{
			description: `the same block with the break in front of the brace spelled with a carriage return`,
			code: `a {\n\t@extend .b\r}`,
			fixed: `a {\n\t@extend .b }`,
			line: 2,
			column: 12,
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			description: `a form feed closing the comment the flag stands in the text of, which Sass reads a line in: the brace stands in code behind it and the space the option asks for goes in`,
			code: `a {\f\tcolor: red // c !important\f\t;\f}`,
			fixed: `a {\f\tcolor: red // c !important\f\t; }`,
			line: 1,
			column: 37,
			message: messages.expectedBefore(),
		},
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			code: `a {\f\tcolor: red // c !important\f\t;\f}`,
			fixed: `a {\f\tcolor: red // c !important\f\t;\f}`,
			line: 1,
			column: 35,
			message: messages.expectedBefore(),
		},
