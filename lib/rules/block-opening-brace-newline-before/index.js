		...
		function check (statement) {
			...
			checker.beforeAllowingIndentation({
				...
				err: (m) => {
					...
					// and `never` demands that the brace joins the comment's line, which nothing can grant
					let isFixable = !(primary.startsWith(`never`) && endsWithInlineComment(between, readsInlineComments(statement, result)))
