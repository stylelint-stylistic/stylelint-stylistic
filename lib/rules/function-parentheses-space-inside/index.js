...
function rule (primary) {
	return (root, result) => {
		...
		root.walkDecls((decl) => {
			...
			let inlineComments = findInlineCommentSpans(declValue, endsInlineCommentOnFormFeed(decl), reading.spells)
			...
			parsedValue.walk((valueNode) => {
				...
				function isOpeningFixable () {
					return !movesOpeningIntoComment(declValue, valueNode, reading)
				}
				...
				function isClosingFixable () {
					return !movesClosingIntoComment(declValue, valueNode, reading)
				}
