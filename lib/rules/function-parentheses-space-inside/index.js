...
import { EVERY_FORM_FEED } from "../../regexps.js"
 ...
 */
function movesOpeningIntoComment (declValue, valueNode, spellsInlineComments) {
		...
		root.walkDecls((decl) => {
			...
			parsedValue.walk((valueNode) => {
				...
				function isOpeningFixable () {
					return !movesOpeningIntoComment(declValue, valueNode, spellsInlineComments)
				}
				...
				function isClosingFixable () {
					return !movesClosingIntoComment(declValue, valueNode, spellsInlineComments)
				}
