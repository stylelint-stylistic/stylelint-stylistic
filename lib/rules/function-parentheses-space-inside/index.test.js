...
testRule({
	...
	accept: [
		...
		{
			// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/132
			description: `a separator of Unicode, which no reading of a line break here counts: the comment runs past it to the end of the value, and the parenthesis the parser closed the call on stands in its text`,
...
testRule({
	...
	accept: [
		...
		{
			// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/132
			description: `a separator of Unicode standing where the fix writes, which no reading of a line break here counts: the comment runs past it to the end of the value, and the parenthesis the parser closed the call on stands in its text`,
...
testRule({
	...
	accept: [
		{
			// https://github.com/stylelint-stylistic/stylelint-stylistic/issues/132
			description: `the separator under a single-line option, which the guard is asked under as well: a function whose only break is one no reading of a line counts is single-line, and the comment holds the parenthesis the parser closed the call on`,
			code: `a { t: translate(1px, 2px // c\u2028 ); }`,
		},
	],
})
