...
import { EVERY_WHITESPACE, LEADING_LINE_BREAK, LINE_BREAK, SEMICOLON_RUN, WHITESPACE } from "../../regexps.js"
import { addNamespace } from "../../utils/addNamespace/index.js"
import { blockString } from "../../utils/blockString/index.js"
import { getBlockAfter } from "../../utils/getBlockAfter/index.js"
...
import { lastNodeHoldsTheBlockAfter } from "../../utils/lastNodeHoldsTheBlockAfter/index.js"
import { setBlockAfter } from "../../utils/setBlockAfter/index.js"
...
function rule (primary, _secondaryOptions, context) {
	return (root, result) => {
		 ...
		 * @param {import('postcss').Rule | import('postcss').AtRule} statement - The rule or at-rule node to check.
		 */
		function check (statement) {
			...
			let isFixable = primary.startsWith(`always`) || !writesIntoInlineComment(statement.last, result, lastNodeHoldsTheBlockAfter(statement) ? undefined : blockAfter.replaceAll(EVERY_WHITESPACE, ``))
					...
					fix: isFixable
						? () => {
							...
							if (primary.startsWith(`always`)) {
								...
								setBlockAfter(statement, newlineIndex >= 0 ? newlineBefore + newlineAfter.slice(newlineIndex) : newlineBefore + context.newline + newlineAfter)
							}
