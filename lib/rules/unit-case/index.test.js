		...
		},
		{
			...
			warnings: [
				...
				},
				{
					...
					endLine: 1,
					endColumn: 17,
					// The unit this second warning names is no unit of any language: reading a whole multiplication as one dimension is https://github.com/stylelint-stylistic/stylelint-stylistic/issues/297, and this case pins where the two warnings stand rather than what either calls a unit
		...
		},
		{
			...
			warnings: [
				...
				},
				{
					...
					endColumn: 14,
					// The unit this second warning names is no unit of any language: reading a whole multiplication as one dimension is https://github.com/stylelint-stylistic/stylelint-stylistic/issues/297, and this case pins where the two warnings stand rather than what either calls a unit
					message: messages.expected(`*10PX`, `*10px`),
				},
			],
		},
		{
