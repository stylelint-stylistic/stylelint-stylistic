...
testRule({
	...
	reject: [
		...
		{
			description: `the same in front of the form feed that ends such a comment`,
			code: `//  \fb {}`,
			fixed: `//\fb {}`,
			warnings: [
				{
		...
		{
			description: `the same in front of a bare carriage return`,
			code: `//  \rb {}`,
			fixed: `//\rb {}`,
			warnings: [
				{
...
testRule({
	...
	reject: [
		...
		{
			description: `the same with a bare carriage return between them and two more spaces, which that syntax reads as no end of the comment`,
			// The whitespace in front of the break was already trimmed by the walk over the raw's lines; the two spaces behind it are what the end of the comment now reaches.
			code: `//  \r  `,
			fixed: `//\r`,
			warnings: [
				{
		...
		{
			description: `the same two spaces behind a form feed standing at the very start of such a comment, with nothing in front of it`,
			code: `//\f  `,
			fixed: `//\f`,
			warnings: [
				{
