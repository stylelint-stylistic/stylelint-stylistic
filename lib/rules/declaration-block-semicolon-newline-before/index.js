						...
						fix: isFixable
							? () => {
								if (primary.startsWith(`always`)) {
									...
									if (decl.important) decl.raws.important = (decl.raws.important || ` !important`).replace(TRAILING_WHITESPACE, context.newline)
									else setDeclarationValue(decl, value.replace(TRAILING_WHITESPACE, context.newline))
