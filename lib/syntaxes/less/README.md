...
- `unit-case` walks the value of a variable the way it walks a declaration's, wherever the params hold the whole of that value: `postcss-less` marks the declaration only where the colon closed the name, and Less declares the variable with whitespace in front of the colon just as readily, `@v : 10PX`;
