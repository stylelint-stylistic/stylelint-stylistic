...
Object.defineProperty(rulesPlugins, `extends`, {
	get () {
		let error = /** @type {import('./utils/configurationError/index.ts').ConfigurationError} */ (new Error(`"@stylistic/stylelint-plugin" is a plugin, not a shareable config, so it cannot be used in "extends". List it in "plugins" instead, and put the rules you need, each namespaced with "@stylistic/", in "rules".`))
