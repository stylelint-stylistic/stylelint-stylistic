...
/** Every line feed and carriage return of a text, a Windows break counting as two. Read by `no-eol-whitespace` to find where the lines end, which is this file's question and not `linebreaks`'s: that a form feed is missing from it is not deliberate and is #247. */
