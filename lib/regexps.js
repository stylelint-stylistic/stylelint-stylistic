...
/** A line feed or a carriage return, the two breaks every syntax reads as one. Read by `linebreaks`, which asks which of those two characters a file ends its lines with — a form feed is neither, so this is one of the five narrow readings in this file that are narrow on purpose. */
