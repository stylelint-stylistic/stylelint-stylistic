 ...
 *
 * CSS closes such an escape with one whitespace character, so `10px\9 2PX` is one dimension token; `postcss-value-parser` reads no escape and parts it into two words with a space node between. Every triple of a word ending in an open escape, a space node of the one closing character and a word becomes one word, asked again, a chain being one token.
 *
