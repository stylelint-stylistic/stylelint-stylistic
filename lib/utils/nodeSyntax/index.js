 ...
 * @returns {import('postcss').Syntax | undefined} That syntax, undefined where the file was read as plain CSS.
 */
export function nodeSyntax (node, result) {
	let root = node.root()

	return (root.source && /** @type {{ syntax?: import('postcss').Syntax }} */ (root.source).syntax) || (result && result.opts && result.opts.syntax)
}
