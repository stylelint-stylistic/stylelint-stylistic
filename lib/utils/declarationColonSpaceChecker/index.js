...
export function declarationColonSpaceChecker (opts) {
	opts.root.walkDecls((decl) => {
		...
		// For custom properties with whitespace-only values, PostCSS puts the whitespace in `decl.value` instead of `decl.raws.between`. We need to preserve the whitespace after the colon so the checker can validate it correctly.
