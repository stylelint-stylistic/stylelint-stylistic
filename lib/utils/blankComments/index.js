 ...
 * @param {(CommentSpan | import('../findInlineCommentSpans/index.js').InlineCommentSpan)[]} [spans] - The spans its comments occupy in it, where they are already known, from either scan.
