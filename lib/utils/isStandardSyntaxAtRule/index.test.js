 ...
 * @param {{ parse: import('postcss').Parser }} [parser] - The syntax to read it with.
 * @returns {import('postcss').AtRule[]} The at-rules, in the order the walk meets them.
 */
 ...
 * @param {string} code - The stylesheet.
 * @returns {import('postcss').AtRule[]} The at-rules.
 */
