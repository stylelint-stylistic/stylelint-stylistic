 ...
 * @param {number} index - The index in the text the edits left behind.
 * @param {Edit[]} edits - The edits that were written into the text.
 * @returns {number} The index in the text they were written into.
 */
export function toIndexBeforeEdits (index, edits) {
	let editedIndex = 0
	let textIndex = 0
