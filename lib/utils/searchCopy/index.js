 ...
 * @param {string} text - The text the search is to run over, a value or a set of parameters.
 * @param {import('postcss').Node} node - The node that text was read from.
 * @param {import('stylelint').PostcssResult} result - The Stylelint result, which the syntax of the file is read from.
 * @returns {{ searchString: string, commentSpans: CommentSpan[] }} The copy to hand the search, and the spans the comments occupy in the text it was made of.
 */
export function searchCopy (text, node, result) {
