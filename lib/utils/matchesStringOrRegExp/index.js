 ...
 * @returns {false | {match: string, pattern: (string | RegExp), substring: string}} False where nothing matched, or the match, the pattern it was made against and the substring it covers.
 */
