...
import { opensAnAddress } from "../opensAnAddress/index.js"
import { optionsMatches } from "../optionsMatches/index.js"
import { inlineCommentReading } from "../readsInlineComments/index.js"
import { setDeclarationValue } from "../setDeclarationValue/index.js"
import { isValueFunction } from "../typeGuards/index.js"
...
export function functionCommaSpaceChecker (opts) {
	...
	opts.root.walkDecls((decl) => {
		...
		parsedValue.walk((valueNode, at, siblings) => {
			 ...
			 * @param {ValueParserDivNode} commaNode - The comma the problem is about.
			 * @param {number} nodeIndex - The index of that comma among the arguments.
			 * @returns {(message: string) => void} The callback, which reports the message it is handed at the comma.
			 */
