...
import { getBlockAfter } from "./index.js"
 ...
 * @returns {ReturnType<typeof getBlockAfter>} What the util answers.
 */
function run (css, syntax) {
	let root = syntax ? syntax.parse(css) : parse(css)

	return getBlockAfter(/** @type {import('postcss').Container} */ (root.first))
}
