 ...
 * @returns {number} The index the break opens at, or the end of the string where the comment runs to it.
 */
function findLineBreak (text, openIndex) {
 ...
 */
export function findCommentSpans (text, spellsInlineComments = true) {
	/** @type {CommentSpan[]} */
	let spans = []
	let index = 0
