 ...
 * @param {(CommentSpan | import('../findInlineCommentSpans/index.js').InlineCommentSpan)[]} [spans] - The spans the comments of the text occupy in it, both kinds of them, where they are already known. A caller that leaves one out leaves the slash it opens on unguarded.
 * @returns {string} The text, with the second slash of every false comment opening written as a question mark.
 */
