...
/** @typedef {import('postcss').Container} PostcssContainer */
 ...
 * @param {PostcssContainer | void} container - The container to look inside.
 * @returns {PostcssChildNode | null} The last non-comment node, or null where the container holds none.
 */
export function lastNonCommentNode (container) {
