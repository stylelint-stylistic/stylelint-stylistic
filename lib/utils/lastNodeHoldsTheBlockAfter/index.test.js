...
import { lastNodeHoldsTheBlockAfter } from "./index.js"
 ...
 * @returns {ReturnType<typeof lastNodeHoldsTheBlockAfter>} What the util answers.
 */
function run (css, syntax) {
	let root = syntax ? syntax.parse(css) : parse(css)

	return lastNodeHoldsTheBlockAfter(/** @type {import('postcss').Container} */ (root.first))
}
