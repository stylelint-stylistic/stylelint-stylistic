 ...
 * @template {import('postcss').Container} T
 * @param {T} statement - The statement carrying the block.
 * @returns {statement is T & { last: import('postcss').AtRule }} True where the last node of the block holds that run.
 */
