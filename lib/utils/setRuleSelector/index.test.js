...
import { setRuleSelector } from "./index.js"
...
describe(`setRuleSelector`, () => {
	...
	it(`writes the copy the syntax prints`, () => {
		...
		expect(/** @type {import('../typeGuards/index.js').SyntaxRaw} */ (node.raws.selector).scss).toBe(`a // c\r\n, b`)
	})
	...
	it(`keeps the raw beside it in step`, () => {
		...
		expect(/** @type {import('../typeGuards/index.js').SyntaxRaw} */ (node.raws.selector).raw).toBe(`a /* c*/\r\n, b`)
	})
