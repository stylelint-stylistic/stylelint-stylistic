...
/** @typedef {import('postcss-value-parser').FunctionNode} ValueParserFunctionNode */
 ...
 * @param {number} index - The comma's place among the arguments.
 * @param {ValueParserFunctionNode} functionNode - The function the comma divides the arguments of.
 * @param {'before' | 'after'} position - The side of the comma being written.
 * @returns {number} The length of the run the neighbour holds, or zero where the comma holds its own.
 */
function runHeldByNeighbour (index, functionNode, position) {
 ...
 */
function whitespaceEdit (div, index, functionNode, position, text) {
