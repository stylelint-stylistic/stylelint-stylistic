 ...
 * @param {import('postcss').AtRule | import('postcss-less').AtRule} atRule - The at-rule node to read.
 * @returns {boolean} True where the node is a call to a detached ruleset.
 */
export function isLessDetachedRulesetCall (atRule) {
