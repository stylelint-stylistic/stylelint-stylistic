...
import { isLessDetachedRulesetCall } from "./index.js"
 ...
 * @param {number} [index] - Which at-rule, counted in the order the walk meets them.
 * @returns {import('postcss').AtRule} That at-rule.
 */
function lessAtRule (code, index = 0) {
