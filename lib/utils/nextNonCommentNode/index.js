 ...
 * @param {(comment: PostcssNode, nextNode: PostcssNode | undefined) => void} [onComment] - Called for each comment the walk steps over, with the node standing behind that comment.
