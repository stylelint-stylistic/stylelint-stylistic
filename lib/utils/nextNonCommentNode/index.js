import { isComment } from "../typeGuards/index.js"
 ...
 * @param {(comment: import('postcss').Comment, nextNode: PostcssNode | undefined) => void} [onComment] - Called for each comment the walk steps over, with the node standing behind that comment.
 * @returns {PostcssNode | null} The next non-comment node, or null if none exists.
 */
export function nextNonCommentNode (startNode, onComment) {
	let node = startNode
