import { HEX_ESCAPE_TERMINATOR, TRAILING_HEX_ESCAPE } from "../../regexps.js"
 ...
 * @param {import('postcss-value-parser').Node} valueNode - The call.
 * @param {number} index - Where the call stands among its siblings.
 * @param {import('postcss-value-parser').Node[]} siblings - The nodes the call stands among.
 * @returns {string} The name, escapes unresolved and in the case the file writes it.
 */
function readName (valueNode, index, siblings) {
 ...
 * @param {import('postcss-value-parser').Node} valueNode - The node to ask about.
 * @param {number} index - Where the node stands among its siblings.
 * @param {import('postcss-value-parser').Node[]} siblings - The nodes the node stands among.
 * @returns {boolean} True where the node is a call opening an address.
 */
export function opensAnAddress (valueNode, index, siblings) {
