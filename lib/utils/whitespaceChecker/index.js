 ...
 * @property {string} [lineCheckStr] - Single- and multi-line checkers will use this string to determine whether they should proceed, i.e. if this string is one line only, single-line checkers will check, multi-line checkers will ignore. Only where none is passed at all do they use `source` in its place: an empty text is a text, and it stands on one line, while `source` may be the whole of a construct broken across several.
