...
export function findInlineCommentSpanHolding (valueNode, spans) {
	return spans.find(({ start, end }) => valueNode.sourceIndex >= start && valueNode.sourceIndex < end)
}
