 ...
 * @returns {string | undefined} The break the file ends its lines with, or `undefined` where it spells none — a file written on one line, and a file whose only breaks stand inside its comments and its strings.
 */
