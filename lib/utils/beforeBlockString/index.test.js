...
/**
 * Reads the first statement of a stylesheet and hands back what stands in front of its block.
 * @param {string | { noRawBefore?: boolean }} [options] - The options of the call, or the stylesheet itself where there are none.
 * @param {string} [cssString] - The stylesheet, where the options come first.
...
function postcssCheck (options, cssString, syntax = postcss) {
	...
	return beforeBlockString(/** @type {import('postcss').Container} */ (root.first), /** @type {import('stylelint').PostcssResult} */ (/** @type {unknown} */ ({ opts: { syntax } })), typeof opts === `string` ? {} : opts)
}
